...
public class AddCategoryDialog extends JDialog {
    ...
    public AddCategoryDialog(JFrame parent, CategoryDAO categoryDAO, int userId, Runnable onCategoryAdded) {
        ...
        setupEventHandlers(categoryDAO, userId, onCategoryAdded);
    }
    ...
    private JPanel createFormPanel() {
        ...
        addFormRow(formPanel, "Transaction Type:", typeBox, gbc, 1);
    ...
    private void setupEventHandlers(CategoryDAO categoryDAO, int userId, Runnable onCategoryAdded) {
